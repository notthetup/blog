...
[![](http://static.flickr.com/7/8916354_adb5e0bf5c_m.jpg)](http://www.flickr.com/photos/davekellam/8916354/)
...
**Documentation.**
Everyone hates to write documents. My FYP supervisor made it a point to make me write proper [Java Docs](http://java.sun.com/j2se/javadoc/) for every Class I made. It was **boring** and tedious. But now, I curse for every line of comment missing in the code I am reading. Sometimes, even the most lame and redundant comments help people to understand the code.
...
**Version control.**
Never actually learned it in school. Had to use [SVN](http://subversion.tigris.org/) for my FYP. Found it annoying. (Actually still do :p ). But with huge projects like at work, I have realised that Version control is indispensible. Althought management of such systems gets really **painful**. A properly setup system can be almost transparent!
