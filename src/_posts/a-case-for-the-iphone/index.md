...
But after listening to a recent episode of TWiT, and the constant argument by Dan from [Tech65](http://tech65.org) that iPhone's best feature is it's full fledged browser, I realised that maybe it did have a place in my world..

It all begins with RSS. Dave Winer, the guy who pioneered RSS was on [episode 134 of TWiT](http://twit.tv/134) (yes, yes, the infamous one) mentioning how iTunes' use of RSS, for podcasts, is nowhere near the potential that [RSS](http://en.wikipedia.org/wiki/RSS_(file_format)) provides. One of Dave's envisioned use of RSS for podcasts would be to have a mobile device that would allow the aggregation of Podcasts wirelessly_(~ 40mins from the start)_.
