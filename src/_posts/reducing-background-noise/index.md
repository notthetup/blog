...
[![recording](./mattinsg.jpg)](https://twitter.com/gamerz/status/474118691173322752/photo/1)
...
<audio controls="controls" preload="none">
	<source src="./prelevel.wav" type="audio/wav">
</audio>
...
<audio controls="controls" preload="none">
	<source src="./postlevel.wav" type="audio/wav">
</audio>
...
<audio controls="controls" preload="none">
	<source src="./postfilter.wav" type="audio/wav">
</audio>
