...
Recent developments with [HTML5](http://www.html5rocks.com/en/) and specifically [WebAudio](https://dvcs.w3.org/hg/audio/raw-file/tip/webaudio/specification.html) stuff has made me take a serious look at Web Technologies. And I'm pretty disappointed by what I see.
...
Making a Web based UI right is HARD! And more often than not, I've seen developers 'trial-error' their way out of making stuff look the way you want it. The [colossal number of CSS properties available](http://www.w3.org/TR/CSS21/propidx.html) for use doesn't really help to have a concrete understanding of view rendering and what really happens when you apply specific properties to an Element.
...
![audio codec support](/img/2013/07/codec.png)
